...
const SCHEDULE: readonly ScheduleEntry[] = [
  {
    agendaWhen: 'Live',
    agendaSub: 'Supabase Edge Function',
    kind: 'recurring',
    workflow: 'Ranking sync (KMR)',
    cron: 'External scheduler',
    what: 'Downloads the latest driver list and leaderboard from KMR, writes the live Supabase Storage objects, and stores rank_history snapshots.',
  },
  {
    agendaWhen: '~1 min',
    ...
    what: 'Checks the AC Elite server often so the site can show who is online, which track is running, and session info from live Supabase data.',
  },
  {
    ...
    cron: 'push main',
    what: 'Rebuilds the public site when the website code changes. Runtime data is read from Supabase.',
  },
];
